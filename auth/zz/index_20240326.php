                    ...
                    <tbody id="none" class="">
                        <?php foreach($showAllUsers_none as $user_none){ ?>
                            <tr>
                                ...
                                <td class="t_left" id="<?php echo 'emp_id_'.$user_none["emp_id"];?>"><?php echo $user_none["emp_id"]." / ".$user_none["cname"]." / ";?><a href="#" data-bs-toggle="modal" data-bs-target="#user_modal" onclick="edit_module('user',<?php echo $user_none['id'];?>)"><?php echo $user_none["user"]; ?></a></td>
                                ...
                                <td class="text-start" <?php if($user_none["role"] == "0"){ ?> style="background-color:yellow" <?php } ?>>
                                    <?php switch($user_none["role"]){
                                        ...
                                        default: echo "停用";} ?></td>
                                <td class="text-start"><?php echo $user_none["idty"];?>
                                ...
                                <td>
                                    ...
                                    <button type="button" value="<?php echo $user_none["id"];?>" class="btn btn-sm btn-xs btn-secondary" title="編輯"
                    ...
                    <tbody id="new" class="unblock">
                        <?php foreach($showAllUsers_new as $user_new){ ?>
                            <tr>
                                ...
                                <td class="t_left" id="<?php echo 'emp_id_'.$user_new["emp_id"];?>"><?php echo $user_new["emp_id"]." / ".$user_new["cname"]." / ";?><a href="#" data-bs-toggle="modal" data-bs-target="#user_modal" onclick="edit_module('user',<?php echo $user_new['id'];?>)"><?php echo $user_new["user"]; ?></a></td>
                                ...
                                <td>
                                    ...
                                    <button type="button" value="<?php echo $user_new["id"];?>" class="btn btn-sm btn-xs btn-secondary" title="編輯"
                                        data-bs-toggle="modal" data-bs-target="#user_modal" onclick="edit_module('user',this.value)" ><i class="fa-solid fa-pen-to-square"></i></button>
                                </td>
                            </tr>
                        <?php }?>
                    ...
                    <tbody id="pause" class="unblock">
                        <?php foreach($showAllUsers_pause as $user_pause){ ?>
                            <tr>
                                ...
                                <td class="t_left" id="<?php echo 'emp_id_'.$user_pause["emp_id"];?>"><?php echo $user_pause["emp_id"]." / ".$user_pause["cname"]." / ";?><a href="#" data-bs-toggle="modal" data-bs-target="#user_modal" onclick="edit_module('user',<?php echo $user_pause['id'];?>)"><?php echo $user_pause["user"]; ?></a></td>
                                ...
                                <td>
                                    <div class="" style="">
                                        <button type="button" value="<?php echo $user_pause["id"];?>" class="btn btn-sm btn-xs btn-secondary" title="編輯"
                                            data-bs-toggle="modal" data-bs-target="#user_modal" onclick="edit_module('user',this.value)" ><i class="fa-solid fa-pen-to-square"></i></button>
                                        <?php if($user_pause["role"] == ""){ ?>
                                            <form action="" method="post" style="display: inline-block;">
                                                <input type="hidden" name="id" value="<?php echo $user_pause["id"];?>">
                                                <button type="submit" class="btn btn-sm btn-xs btn-danger" title="刪除" onclick="return confirm('確認刪除？')"><i class="fa-solid fa-user-xmark"></i></button>
                                            </form>
                                        <?php } ?>
                                    </div>    
                                </td>
