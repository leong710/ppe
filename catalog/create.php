...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 bg-white border rounded p-4 my-2">
            ...
            <hr>
            <form action="" method="post" enctype="multipart/form-data" onsubmit="this.part_no.disabled=false;">
                <div class="row px-3">
                    <div class="col-12 col-md-6 rounded bg-light">
                        <label for="" class="form-label">PIC/圖片：</label>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 py-1">
                                <div class="form-floating">
                                    <select name="cate_no" id="cate_no" class="form-select" required>
                                        <option value="" selected hidden>--請選擇類別--</option>
                                        <?php foreach($categories as $cate){ ?>
                                            <option value="<?php echo $cate["cate_no"];?>">
                            ...
                            <div class="col-12 py-1">
                                <div class="form-floating">
                                    <input type="text" name="pname" id="pname" class="form-control" required placeholder="品名" >
                                    <label for="pname" class="form-label">pname/品名：<sup class="text-danger"> *</sup></label>
                                </div>
                            </div>
                            <div class="col-12 py-1">
                                <div class="form-floating">
                                    <textarea name="cata_remark" id="cata_remark" class="form-control" style="height: 90px;" placeholder="敘述說明"></textarea>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 py-1">
                                <div class="form-floating">
                                    <input type="text" name="OBM" id="OBM" class="form-control" placeholder="品牌/製造商">
                            ...
                            <div class="col-12 col-md-6 py-1">
                                <div class="form-floating">
                                    <input type="text"  name="size" id="size" class="form-control" placeholder="尺寸">
                                    <label for="size" class="form-label">size/尺寸：</label>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 py-1">
                                <div class="form-floating">
                                    <input type="text" name="unit" id="unit" class="form-control" required placeholder="單位">
                            ...
                            <div class="col-12 py-1">
                                <div class="form-floating">
                                    <textarea name="SPEC" id="SPEC" class="form-control" style="height: 90px;" placeholder="規格"></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 px-4">
                                            <div class="input-group search" id="selectScomp_noForm">
                                                <input type="text" class="form-control" id="key_word" placeholder="請輸入統編或廠商名稱" aria-label="請輸入統編或廠商名稱">
                            ...
                            <div class="col-12 py-1">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="radio" name="flag" id="On" class="form-check-input" value="On" checked >&nbsp
                                            <label for="On" class="form-check-label">On</label>
                                        </td>
                                        <td>
                                            <input type="radio" name="flag" id="Off" class="form-check-input" value="Off" >&nbsp
                        ...
                        <div class="row">
                            <div class="col-12 py-1">
                                <div class="form-floating">
                                    <select name="part_no" id="part_no" class="form-select" disabled>
...
<script>
    ...
    $(document).ready( function () {
        ...
        var pmLists = {};
    //     // 第0階段：套用既有數據
    //     var intt_val_str = row['scomp_no'];                     // 引入副PM資料
    //     var intt_val = [];
