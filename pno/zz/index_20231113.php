                                ...
                                <?php foreach($pnos as $pno){ ?>
                                    <tr>
                                        ...
                                        <td style="text-align: left;"><?php 
                                            ...
                                            // echo isset($price_arr[$_year]) ? $_year."y : $".$price_arr[$_year] : $_year."y : $0";
                                            echo ($_year-1)."y : $"; echo isset($price_arr[$_year-1]) ? number_format($price_arr[$_year-1]) : "0";
                                            echo "</br>".$_year."y : $"; echo isset($price_arr[$_year]) ? number_format($price_arr[$_year]) : "0";
                                        ?></td>
...
<!-- 彈出畫面模組 新增PNO料號<span id="idty_title"></span>&nbsp? -->
                ...
                <form action="" method="post">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4 py-1">
                                <div class="form-floating">
                                    <input type="text" name="_year" id="_year" class="form-control" required placeholder="_year建立年度" value="<?php echo $thisYear;?>">
                                    <label for="_year" class="form-label">_year/建立年度：<sup class="text-danger"> *</sup></label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 py-1">
                                <div class="form-floating">
                            ...
                            <div class="col-12 col-md-4 py-1">
                                <div class="form-floating">
                                    <input type="text" name="_quoteYear" id="_quoteYear" class="form-control" required placeholder="_quoteYear年度" value="<?php echo $thisYear;?>">
                                    <label for="_quoteYear" class="form-label">_quoteYear/報價年度：<sup class="text-danger"> *</sup></label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 py-1">
                                <div class="form-floating">
                                    <input type="number" name="_price" id="_price" class="form-control" required placeholder="_price單價" min="0" value="0">
                                    <label for="_price" class="form-label">_price/單價：<sup class="text-danger"> *</sup></label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 py-1">
                                <table>
                    ...
                    <div class="modal-footer">
                        <div class="text-end">
                            ...
                            <?php if($_SESSION[$sys_id]["role"] <= 1){ ?>   
                                <input type="submit" value="新增" name="pno_submit" class="btn btn-primary">
                            <?php } ?>
...
<script>
    ...
    var _year    = String(<?=$_year;?>);                                                             // 引入$_year資料
            ...
            if(row['id'] == row_id){
                ...
                Object(window[to_module+'_item']).forEach(function(item_key){
                    if(item_key == 'id'){
                        ...
                        console.log('price_json_parse:', price_json_parse);
                        if(!price_json_parse[_year]){
                            price_json_parse[_year] = 0;
                        }

                        document.querySelector('#edit_'+to_module+' #edit_quoteYear').value = _year; 
                        document.querySelector('#edit_'+to_module+' #edit_price').value = price_json_parse[_year]; 
                    }else{
