...
// // // 領用單 CRUD 20240126
    // 儲存pt_receive領用申請表單 20240126  // 20240220_增加mapp推播訊息
    function store_ptreceive($request){
        ...
        try {
            ...
            // 20240220_增加mapp推播訊息
            $swal_json["msg"]     .= "【環安PPE系統】除汙器材領用申請通知\n(".$created_cname.") 在 ".$fab_title." 已提出申請待您確認";
            $swal_json["msg"]     .= "\n，如已確認完畢，請忽略此訊息！\n** 請至以下連結查看申請文件：\nhttp://tw059332n.cminl.oa/ppe/pt_stock/pt_receive.php";
