                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-3 px-1">
                        <div class="row">
                            ...
                            <!-- 下 -->
                            <div class="col-6 col-md-12 pt-0 unblock">
                                <div class="border rounded px-3 py-2" style="background-color: #D4D4D4;">
                    ...
                    <div class="col-12 col-md-9 px-1">
                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link active" id="nav-inSign-tab" data-bs-toggle="tab" data-bs-target="#nav-inSign" type="button" role="tab" 
                                    aria-controls="nav-home" aria-selected="true">1.待簽核文件
                                        <?php echo count($my_inSign_lists) >0 ? "<span class='badge rounded-pill bg-warning text-dark'> +".count($my_inSign_lists)."</span>" :"" ;?></button>
                                <button class="nav-link" id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review" type="button" role="tab" 
                                    aria-controls="nav-review" aria-selected="false">2.申請新文件</button>
                                <button class="nav-link" id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review" type="button" role="tab" 
                                    aria-controls="nav-review" aria-selected="false">3.已申請文件</button>
                        ...
                        <div class="tab-content rounded bg-light" id="nav-tabContent">
                            <!-- 1.待簽核文件 -->
                            <div class="tab-pane fade show active" id="nav-inSign" role="tabpanel" aria-labelledby="nav-inSign-tab">
                                <div class="col-12 px-4">
                                    <?php if(count($my_inSign_lists) >0){ ?>
                                        <table id="catalog_list" class="catalog_list table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php foreach($my_inSign_lists as $my_inSign){ ?>
                                                    <tr>
                                                        <td><a href="show.php?uuid=<?php echo $my_inSign['uuid'];?>&action=sign"><?php echo substr($my_inSign['created_at'],0,10);?></a></td>
                                                        <td><?php echo $my_inSign['fab_title'];?></td>
                                                        <td><?php echo $my_inSign['plant']." / ".$my_inSign['dept'];?></td>
                                                        <td><?php echo $my_inSign["cname"]." (".$my_inSign["emp_id"].")";?></td>
                                                        <td><?php switch($my_inSign['idty']){
                                                                    case "0"    : echo "待領";                  break;
                                                                    case "1"    : echo "待簽";                  break;
                                    ...
                                    <?php }else{ ?>
                                        <span class="text-danger">[ 您沒有待簽核的文件! ]</span>
                                    <?php } ?>
