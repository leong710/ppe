...
(77, 'B', 'P-049', '皮革圍裙', 'P-049.png', '', '不指定', '', '單尺寸', '件', '1. 使用豬面皮製成\r\n2. 尺寸：0.6 mm(厚)*93 cm(長)*68 cm(寬)。\r\n3. 可耐切割穿刺。\r\n4.可耐熱60度以上', 'R12041106PG0', '', 999, 999, 'On', '2023-10-26 10:24:12', '2023-07-05 15:02:00', '陳建良'),
...
(2, 1, 'FAB1棟', '一廠', 'a', 'On', '9T041502', '10119798,沈旻頡', '2023-07-04 15:11:08', '2023-11-08 11:37:16', '陳建良'),
...
(8, 1, 'FAB7棟', '七廠', 'a', 'On', '9T041501', NULL, '2023-07-04 15:13:30', '2023-10-26 13:53:12', '陳建良'),
(9, 1, 'FAB8棟', '八廠', 'a', 'On', '9T044502', NULL, '2023-07-04 15:14:07', '2023-10-26 13:54:18', '陳建良'),
(10, 1, 'LCM棟', 'C廠區', 'b', 'On', '9T042502', '10009261,施昱丞,13085117,鄭羽淳', '2023-07-04 15:14:29', '2023-11-08 11:19:40', '陳建良'),
(11, 1, 'TOC棟', 'TOC', 'b', 'On', '9T042501', NULL, '2023-07-04 15:15:35', '2023-10-26 13:55:17', '陳建良'),
...
CREATE TABLE `_pno` (
  ...
  `price` varchar(255) NOT NULL COMMENT '年度/單價NT$',
...
(140, 'AE86', '', '2023', '{\"2022\":\"10\",\"2023\":\"9\"}', 'P-014', '單一', 'On', '2023-11-13 15:35:08', '2023-11-27 10:21:00', '陳建良');
...
CREATE TABLE `_receive` (
  ...
  `collect` longtext DEFAULT NULL COMMENT '實發數量',
...
(2, '10008048', 'leong.chen', '陳建良', '0', '12', '2022-08-15 13:58:58', '1', '1'),
...
--
ALTER TABLE `_users`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ai', AUTO_INCREMENT=13;
COMMIT;
