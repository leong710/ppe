            ...
            <form action="update.php" method="post"   onsubmit="this.local_id.disabled=false, this.catalog_id.disabled=false, this.standard_lv.disabled=false, this.amount.disabled=false, 
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 py-1">
                                <div class="form-floating">
                                    <select name="local_id" id="local_id" class="form-control" <?php echo ($_SESSION[$sys_id]["role"] > 0) ? " disabled ":" required ";?>>
                                    ...
                                    <label for="local_id" class="form-label">local/儲存點位置：<sup class="text-danger"><?php echo ($_SESSION[$sys_id]["role"] > 0) ? " - disabled":" *";?></sup></label>
                                </div>
                            </div>
                            
                            <div class="col-12 col-md-6 py-1">
                                <div class="form-floating">
                                    <select name="catalog_id" id="catalog_id" class="form-control" <?php echo ($_SESSION[$sys_id]["role"] > 0) ? " disabled ":" required ";?> >
                                    ...
                                    <label for="catalog_id" class="form-label">catalog/衛材名稱：<sup class="text-danger"><?php echo ($_SESSION[$sys_id]["role"] > 0) ? " - disabled":" *";?></sup></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 py-0">
                                <div class="form-floating">
                                    <input type="number" name="standard_lv" id="standard_lv" class="form-control t-center" placeholder="標準數量(管理員填)" min="1" max="400"
                                        <?php echo ($_SESSION[$sys_id]["role"] >= 1) ? " readonly ":""; ?> value="<?php echo $stock["standard_lv"];?>" >
                            ...
                            <div class="col-12 col-md-6 py-0">
                                <div class="form-floating pb-0">
                                    <input type="date" name="lot_num" id="lot_num" class="form-control" required value="<?php echo $stock["lot_num"];?>" <?php echo ($_SESSION[$sys_id]["role"] > 1) ? " readonly ":"";?>>
                                    <label for="lot_num" class="form-label">lot_num/批號/期限：<sup class="text-danger"><?php echo ($_SESSION[$sys_id]["role"] > 1) ? " - disabled":" *";?></sup></label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 py-0">
                                <div class="form-floating">
                                    <input type="text" name="po_num" id="po_num" class="form-control" placeholder="PO編號" value="<?php echo $stock["po_num"];?>" <?php echo ($_SESSION[$sys_id]["role"] > 1) ? " readonly ":"";?> >
                                    <label for="po_num" class="form-label">po_num/PO編號：<sup class="text-danger"><?php echo ($_SESSION[$sys_id]["role"] > 1) ? " - disabled":" *";?></sup></label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 py-0">
                                <div class="form-floating">
                                    <textarea name="d_remark" id="d_remark" class="form-control" style="height: 100px" <?php if($_SESSION[$sys_id]["role"] > 1){?>readonly="true"<?php }?>><?php echo $stock["d_remark"];?></textarea>
                ...
                <div class="text-end">
                    ...
                    <?php if($_SESSION[$sys_id]["role"] <= 1 || ( $_SESSION[$sys_id]["role"] <= 2 && 
                            ($_SESSION[$sys_id]["site_id"] == $stock_siteID || in_array($stock_siteID, $_SESSION[$sys_id]["ssite_id"])) )){ ?>
